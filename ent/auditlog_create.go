...
func (_c *AuditLogCreate) SetRole(v string) *AuditLogCreate {
	_c.mutation.SetRole(v)
	return _c
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (_c *AuditLogCreate) SetNillableRole(v *string) *AuditLogCreate {
	if v != nil {
		_c.SetRole(*v)
	}
	return _c
...
func (_c *AuditLogCreate) SetScenarioID(v string) *AuditLogCreate {
	_c.mutation.SetScenarioID(v)
	return _c
}

// SetNillableScenarioID sets the "scenario_id" field if the given value is not nil.
func (_c *AuditLogCreate) SetNillableScenarioID(v *string) *AuditLogCreate {
	if v != nil {
		_c.SetScenarioID(*v)
	}
	return _c
...
func (_c *AuditLogCreate) SetDiff(v map[string]interface{}) *AuditLogCreate {
...
func (_c *AuditLogCreate) check() error {
	...
	if _, ok := _c.mutation.Role(); !ok {
		return &ValidationError{Name: "role", err: errors.New(`ent: missing required field "AuditLog.role"`)}
	}
	if _, ok := _c.mutation.IP(); !ok {
